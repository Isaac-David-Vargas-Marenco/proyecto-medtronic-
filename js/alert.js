...
Swal.fire({
    ...
    icon: 'information',
    html:
      ' inserted name value is : '+name_med+ '<hr>Inserted telephone value is : '+ number_med+ 'inserted email value is : '+email_med+' inserted date value is : '+date_med+' inserted message is : '+text_med,
